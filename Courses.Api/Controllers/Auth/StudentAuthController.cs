...
namespace Courses.Api.Controllers.Auth
{
    ...
    public class StudentAuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequestDto request)
        {
            ...
            {
                return Unauthorized(new { message = "This login is for students only" });
            }
        ...
        [HttpPost("register")]
        public async Task<IActionResult> Register([FromBody] StudentRegisterRequestDto request)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public async Task<IActionResult> VerifyEmail([FromBody] VerifyCodeRequestDto request)
        {
            ...
            if (user.UserType != UserType.Student)
            {
                return BadRequest(new { message = "This verification is for students only" });
            }
